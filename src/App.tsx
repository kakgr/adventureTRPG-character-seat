...
export default function App() { return <Routes><Route path="/login" element={<AuthPage />} /><Route path="/characters" element={<Protected><CharactersPage /></Protected>} /><Route path="/characters/new" element={<Protected><CharacterEditorPage /></Protected>} /><Route path="/characters/:id" element={<Protected><CharacterDetailPage /></Protected>} /><Route path="/characters/:id/edit" element={<Protected><CharacterEditorPage /></Protected>} /><Route path="*" element={<Navigate to="/characters" replace />} /></Routes> }
