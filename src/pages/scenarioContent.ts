    ...
    scenarios: [
      {
        ...
        synopsis:
          "どこかの世界からやってきた渡り手は、気付かぬうちに廃墟になった古屋の中で横たわっていた。",
        genre: "チュートリアル・探索",
        playTime: "45分〜1時間",
        players: "1〜3人",
      ...
      },
      {
        ...
        synopsis:
          "港にきていた渡り手達は、親方のお願いで午前中からそこら辺をうろちょろしている子犬を捕まえることになった。",
        genre: "チュートリアル・戦闘",
        playTime: "30分〜1時間",
        players: "1〜3人",
      ...
      },
      {
        ...
        synopsis:
          "探偵のあなたはヴォルト家の家主ベルト・ヴォルトの残した手紙の解読を依頼された。無事謎を解き、依頼を完了できるか？(探偵必須)",
        genre: "チュートリアル・ミステリー",
        playTime: "30分〜1時間",
        players: "1〜3人",
