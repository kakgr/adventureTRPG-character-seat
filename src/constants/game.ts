...
export const SPECIALIZED_SKILL_GENRES: Record<
  SpecializedSkillId,
  Exclude<SkillGenreId, "custom">
> = {
  weapon: "combat",
  ranged: "combat",
  knowledge: "technical",
...
export const DEFAULT_DATA: CharacterData = {
  ...
  skills: {
    common: Object.fromEntries(COMMON_SKILLS.map(({ id }) => [id, 0])) as Record<
      CommonSkillId,
      number
    >,
    luck: 0,
