...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  useEffect(() => { if (location.pathname.startsWith('/world')) setWorldOpen(true) }, [location.pathname])
