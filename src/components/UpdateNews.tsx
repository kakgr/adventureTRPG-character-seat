...
export function UpdateNews() {
  ...
  return (
    <div className="update-news" ref={newsRef}>
      <button
        type="button"
      ...
      {open && (
        <section className="update-news-panel" id="update-news-panel" aria-label="更新ニュース">
          ...
          <div className="update-news-list">
            {getVisibleUpdateNews(updateNews).map((item) => (
              <article className="update-news-item" key={`${item.version}-${item.title}`}>
